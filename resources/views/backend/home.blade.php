				...
				<div class="list-group">
					...
					<div class="list-group-item">
						...
						<div class="row-content">
							...
							<a href="{{route('admin.roles.create')}}" class="btn btn-primary btn-raised">Create A Role</a>
						</div>
					</div>
					...
					<div class="list-group-item">
						...
						<div class="row-content">
							...
							<a href="{{route('categories.index')}}" class="btn btn-default btn-raised">All Categories</a>
							<a href="{{route('categories.create')}}" class="btn btn-primary btn-raised">New Category</a>
						</div>
					</div>
					<div class="list-group-separator"></div>
				</div>
